...
document.getElementById("btnSi").addEventListener("click", function () {
  ...
  var parrafo = document.querySelector("#cuadroDialogo p");
    parrafo.textContent = "Desde hace tiempo supe que este momento llegaría… Quiero que sepas que me haces muy muy feliz ^^ Te amo❤️";
...
document.getElementById("btnNo").addEventListener("click", function () {
  Swal.fire({
      imageUrl: "https://th.bing.com/th/id/OIP.qF9SaRVSbT24euAffuDWwAHaE8?rs=1&pid=ImgDetMain",
    imageHeight: 350,
